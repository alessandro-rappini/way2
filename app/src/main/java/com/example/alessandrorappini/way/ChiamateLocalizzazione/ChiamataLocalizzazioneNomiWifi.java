 ...
 * la posizione del device in base al confronto dei nomi delle rilevazioni WiFi
 */

public class ChiamataLocalizzazioneNomiWifi {
    static LinkedList ssidR , bssidR , rssidMediaR;
    static int lungR;
    static String nomeR;
    static JSONArray rpRisp = null;
    static  HashMap<String, Integer> myMap ;
    public ChiamataLocalizzazioneNomiWifi(LinkedList ssid, LinkedList bssid, LinkedList rssidMedia, int lung, String nome){
        ssidR = ssid;
        bssidR = bssid;
